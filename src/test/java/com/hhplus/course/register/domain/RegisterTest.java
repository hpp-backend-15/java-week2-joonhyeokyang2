...
public class RegisterTest {
    ...
    void setUp() {
        ...
        lectureItem = LectureItem.of(LectureItemId.of("lectureItem1"), now);
        lectureItems.add(lectureItem);
        lecture = Lecture.from("lecture1", "TDD - 딸깍 주도 개발", "heo jae", lectureItems);
    }
    ...
    void 강의를_수강할수_있어야한다() throws Exception {
        ...
        assertThat(register.getStudents()).isNotEmpty();
    }
